export const translations = {
  en: {
    ...
    planFreeCta: "Create free account →",
  ...
  pt: {
    ...
    planFreeCta: "Criar conta gratuita →",
    ...
    hit: "Hit",
    miss: "Miss",
    levelHit: "Nível atingido",
    levelNotHit: "Nível não atingido",
