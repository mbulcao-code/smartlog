export const fomoTree = {
  ...
  steps: [
    ...
    },
    {
      id: "build",
      type: "complete",
      text: "Here's what we're testing:\n\nVariant A — Early entry: you enter before price reaches your level, anticipating the move.\n\nVariant B — Confirmation entry: you wait for price to reach your level before entering.\n\nSame setup. Same level. Only the timing differs.\n\n---\n\nFor Variant A, the key question isn't 'did the trade hit target?' — it's 'did your level also get hit afterward?'\n\nHere's why that distinction matters — and it's not obvious:\n\nIf you entered early and your level was also hit later, there are two possible outcomes. Either the trade hit target — but that doesn't mean the early entry was right. It means you got a worse price than you needed to. Waiting for the level would have given you a better entry, a tighter stop, and a higher R:R on the same winning trade. Or the trade hit your stop — and this is the part most traders miss: your stop was placed further from the level than it needed to be. You didn't just lose. You lost more than you would have if you'd waited.\n\nIn both cases — target hit or stop hit — if your level was also hit, the early entry cost you something.\n\nIf you entered early and your level was never hit afterward → the early entry was justified. Price moved directly without touching the level. You wouldn't have caught the move by waiting. This is the one case where FOMO served you.\n\nThis is what we're measuring. Not whether you made money — but whether entering early was necessary, or whether it came at a price each time.\n\nYour job: for the next trades where this setup appears, log which variant you used and whether your level got hit. Don't change anything yet — just watch and label.",
    },
  ],
};
