...
export const TRADE_OUTCOME_LABELS = {
  ...
  trailing_stop: {
    en: "Trailing stop",                 pt: "Stop móvel (trailing)",
    details: {
      protected:  { en: "Protected — smaller loss / locked profit", pt: "Protegeu — perda menor / lucro garantido" },
      too_tight:  { en: "Too tight — target was hit after",         pt: "Muito curto — alvo foi atingido depois"   },
    },
  },
  panic_exit: {
